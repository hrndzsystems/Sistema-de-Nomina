...
#include<stdlib.h>
int main(){
	printf("Sistema De Nomina Lust DF");
	printf("Realizado por: Emilio Alonzo Hernandez Hernandez");
	printf("\n Menu \n");
	...
	printf("10. Salir");
	int op, Nombre_Empleado, Turno_Empleado, Sucursal_Empleado, Departamento_Empleado, Puesto_Empleado, Salario_Empleado,Desempenio_Empleado,NmSeguroSocial_Empleado, Antiguedad_Empleado, Salir;
